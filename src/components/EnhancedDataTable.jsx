...
const EnhancedDataTable = ({ data }) => {
  ...
  // Улучшенная функция форматирования валют
  const formatCurrency = (amount, currency = 'TRY') => {
    ...
    try {
      ...
      console.warn('⚠️ Ошибка форматирования валюты:', error, 'currency:', currency)
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      {/* Быстрая статистика (обновленная) */}
